...
import { AIOutineca, AiOutlineCamera } from "react-icons/ai";
        ...
        <div className="w-1/4 h-full flex flex-col gap-1 overflow-hidden">
          <div className="w-full h-2/4 relative">
            <img
              ...
              className="w-full h-full object-cover object-center rounded-lg"
            />
            <div className="absolute inset-0 bg-black bg-opacity-40 h-full rounded-lg" />
            <h4 className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full z-20 text-center text-white font-semibold">
              View Gallery
            </h4>
          </div>
          <div className="w-full h-2/4 relative">
            ...
            />
            <div className="absolute inset-0 bg-black bg-opacity-40 h-full rounded-lg" />
            <div className="absolute flex flex-col items-center left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full z-20 text-center text-white font-semibold">
